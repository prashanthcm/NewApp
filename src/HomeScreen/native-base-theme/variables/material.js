...
export default {
  ...
  tabBarActiveTextColor: "#41BDE1",
  tabActiveBgColor: "#fff",

  // Tab
  tabDefaultBg: "white",
  topTabBarTextColor: "grey",
  topTabBarActiveTextColor: "#41BDE1",
  topTabActiveBgColor: "#41BDE1",
  topTabBarBorderColor: "#fff",
  topTabBarActiveBorderColor: "#41BDE1",
